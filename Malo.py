...
class Ui_Respuesta_Malo(object):
    def setupUi(self, Form,total):
        ...
        pixmap = QtGui.QPixmap('imagenes/Malo.png')
    ...
    def retranslateUi(self, Form):
        ...
        self.label_2.setText(_translate("Form", f"La verdad, aún no me convence, la puntuacion de tu producto es de {self.total} "))
        self.label_3.setText(_translate("Form", "lo que significa que tu producto es:"))
        self.label_4.setText(_translate("Form", "MALO"))
