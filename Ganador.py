...
class Ui_Respuesta_Ganador(object):
    def setupUi(self, Form,total):
        ...
        self.label_2.setGeometry(QtCore.QRect(140, 160, 2000, 121))
        font = QtGui.QFont()
        ...
        self.label_4.setGeometry(QtCore.QRect(720, 370, 700, 161))
        font = QtGui.QFont()
        ...
        pixmap = QtGui.QPixmap('imagenes/ganador.png')
    ...
    def retranslateUi(self, Form):
        ...
        self.label_2.setText(_translate("Form", f"¡EXELENTE! Has conseguido un producto Ganador. La puntuacion de tu producto es de {self.total}"))
        self.label_3.setText(_translate("Form", "lo que significa que tu producto es:"))
        self.label_4.setText(_translate("Form", "¡GANADOR!"))
