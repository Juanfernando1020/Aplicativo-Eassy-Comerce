...
class Ui_Respuesta_Tivio(object):
    def setupUi(self, Form,total):
        ...
        self.label_2.setGeometry(QtCore.QRect(90, 160, 2000, 121))  # Ajusta los valores de posición (50, 160) y ancho (1421)
        font = QtGui.QFont()
        ...
        self.label_4.setGeometry(QtCore.QRect(840, 370, 361, 161))
        font = QtGui.QFont()
        ...
        pixmap = QtGui.QPixmap('imagenes/Tivio.png')
    ...
    def retranslateUi(self, Form):
        ...
        self.label_2.setText(_translate("Form", f"¡Super!, Tienes un buen producto, pero aun puede ser mejor. La puntuacion de tu producto es de {self.total} "))
        self.label_3.setText(_translate("Form", "lo que significa que tu producto es:"))
        self.label_4.setText(_translate("Form", "TIVIO"))
